            ...
            <div class="p-4">
                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-header bg-white fw-bold py-3">
                        <i class="fa fa-pen-to-square me-2"></i>Cập nhật thông tin cá nhân
                    </div>
                        ...
                        <form action="${pageContext.request.contextPath}/account/profile" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="username" class="form-control" value="${sessionScope.account.username}" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12 mt-4 text-end">
                                    <button type="submit" class="btn btn-primary px-4 fw-bold">
                                        <i class="fa fa-floppy-disk me-1"></i>Lưu thay đổi
                                    </button>
                                </div>
                            </div>
                        </form>
