...
public class AdminCategoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path.equals("/admin/category/delete")) {
            ...
            // Dùng include thay cho forward để giữ Response stream chưa bị committed
            req.getRequestDispatcher("/views/catalog/admin/category-add.jsp").include(req, resp);
        } else if (path.equals("/admin/category/edit")) {
            int id = Integer.parseInt(req.getParameter("id"));
            Category cate = cateService.findById(id);
            req.setAttribute("category", cate);
            req.getRequestDispatcher("/views/catalog/admin/category-edit.jsp").include(req, resp);
        } else {
            ...
            req.getRequestDispatcher("/views/catalog/admin/category-list.jsp").include(req, resp);
        }
    }
