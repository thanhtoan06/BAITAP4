...
public class AdminUserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path.equals("/admin/user/delete")) {
            ...
            // Đổi forward -> include
            req.getRequestDispatcher("/views/catalog/admin/user-add.jsp").include(req, resp);
            ...
            // Đổi forward -> include
            req.getRequestDispatcher("/views/catalog/admin/user-edit.jsp").include(req, resp);
            
        } else {
            List<User> list = userService.findAll();
            req.setAttribute("userList", list);
            // Đổi forward -> include
            req.getRequestDispatcher("/views/catalog/admin/user-list.jsp").include(req, resp);
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path.equals("/admin/user/add")) {
            ...
            if (avatarName == null) avatarName = "admin.png";
            ...
            oldUser.setAvatar(avatarName);

            userService.update(oldUser);

            HttpSession session = req.getSession();
            User currentAcc = (User) session.getAttribute("account");
            if (currentAcc != null && currentAcc.getId() == oldUser.getId()) {
