...
public class ProfileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/views/catalog/admin/profile.jsp").include(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        User currentUser = userService.findById(account.getId());
        ...
        if (filePart != null && filePart.getSize() > 0) {
            ...
            try {
                if (contextRealPath != null && contextRealPath.contains(".metadata")) {
                    ...
                    String projectSourcePath = workspacePath + projectName + File.separator + "src" + File.separator + "main" + File.separator + "webapp" + File.separator + "uploads";
